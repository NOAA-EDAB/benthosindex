...
This script tests fall and spring models, no covariates but estimating full spatial and spatio-temporal RE and anistotropy. 

https://github.com/NOAA-EDAB/benthosindex/blob/main/VASTscripts/VASTunivariate_megabenthos_allsurvs.R 
